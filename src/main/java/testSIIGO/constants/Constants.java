...
public class Constants {
    ...
    public static final String LIST_USERS_PER_PAGE = "user_list per page response value";
    public static final String LIST_USERS_TOTAL = "user_list total response value";
}
